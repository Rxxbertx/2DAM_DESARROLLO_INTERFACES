...
namespace PROYECTO_1EVA_RJT.GameStates.Levels
{
    ...
    /// </summary>
    public partial class Level4 : Page, ILevelMethods, StateMethods
    {
        ...
        public Level4(Player player, Game game)
        {
            InitializeComponent();
        ...
        {
            Canvas.SetTop(canvas, lvl4.Height / 2 - (canvas.Height / 2));
            Canvas.SetLeft(canvas, lvl4.Width / 2 - (canvas.Width / 2));
            canvas.Visibility = System.Windows.Visibility.Visible;
            if (canvas.Equals(ui.canvaCompletado))
            {
        ...
        public void CheckInteractions()
        {
            if (player.InteractiveObj != null)
            {
                ...
                if (player.InteractiveObj.Equals("cpu"))
                {
                    GameManager.addInventarioElemento(CargarGuardar.getPiezaFoto("cpu"));
                    LoadCanva(ui.canvaCompletado);
                }
        ...
        public void AddElements()
        {
            ...
            Game.GameManager.GameStateElements(GameState.LVL4);
            ...
            CollidableElements.Add(arbol24Hitbox);
