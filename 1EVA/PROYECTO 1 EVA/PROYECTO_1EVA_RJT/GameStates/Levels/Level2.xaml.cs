...
namespace PROYECTO_1EVA_RJT.GameStates.Levels
{
    ...
    /// </summary>
    public partial class Level2 : Page, ILevelMethods, StateMethods
    {
        ...
        public Level2(Player player, Game game)
        {
            InitializeComponent();
        ...
        {
            Canvas.SetTop(canvas, lvl2.Height / 2 - (canvas.Height / 2));
            Canvas.SetLeft(canvas, lvl2.Width / 2 - (canvas.Width / 2));
        ...
        public void AddElements()
        {
            ...
            Game.GameManager.GameStateElements(GameState.LVL2);
